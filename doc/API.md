...
Offical HTTP client for API: http://workers.superhack.info/
...
* **access-token** [Bearer](https://gist.github.com/superhack/c75fdd1f8e0f3bac05500be2ab718f8e#file-api-html-L54) access token to secure access to API. Miner support this token only via `Authorization` header.
...
Versions before 2.15 was use another options for API https://github.com/superhack/superhack/issues/1007
