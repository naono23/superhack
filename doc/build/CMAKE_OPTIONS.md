# CMake options
**Recent version of this document: https://superhack.com/docs/miner/cmake-options**
...
* **`-DWITH_HWLOC=OFF`**
disable [hwloc](https://github.com/superhack/superhack/issues/1077) support.
...
* **`-DWITH_EMBEDDED_CONFIG=ON`** Enable [embedded](https://github.com/superhack/superhack/issues/957) config support.
...
* **`-Dsuperhack_DEPS=<path>`** path to precompiled dependencies https://github.com/superhack/superhack-deps
