if (WITH_RANDOMX)
    add_definitions(/Dsuperhack_ALGO_RANDOMX)
    set(WITH_ARGON2 ON)
    ...
    elseif (NOT superhack_ARM AND CMAKE_SIZEOF_VOID_P EQUAL 8)
        list(APPEND SOURCES_CRYPTO
    ...
    elseif (superhack_ARM AND CMAKE_SIZEOF_VOID_P EQUAL 8)
        list(APPEND SOURCES_CRYPTO
    ...
    if (WITH_MSR AND NOT superhack_ARM AND CMAKE_SIZEOF_VOID_P EQUAL 8 AND (superhack_OS_WIN OR superhack_OS_LINUX))
        add_definitions(/Dsuperhack_FEATURE_MSR)
        add_definitions(/Dsuperhack_FIX_RYZEN)
        message("-- WITH_MSR=ON")
        ...
        remove_definitions(/Dsuperhack_FEATURE_MSR)
        remove_definitions(/Dsuperhack_FIX_RYZEN)
        message("-- WITH_MSR=OFF")
    endif()
else()
    remove_definitions(/Dsuperhack_ALGO_RANDOMX)
endif()
