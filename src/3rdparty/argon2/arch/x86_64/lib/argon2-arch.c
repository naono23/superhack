...
void argon2_get_impl_list(argon2_impl_list *list)
{
    static const argon2_impl IMPLS[] = {
        ...
        { "SSE2",       superhack_ar2_check_sse2,     superhack_ar2_fill_segment_sse2 },
        { "SSSE3",      superhack_ar2_check_ssse3,    superhack_ar2_fill_segment_ssse3 },
        { "XOP",        superhack_ar2_check_xop,      superhack_ar2_fill_segment_xop },
        { "AVX2",       superhack_ar2_check_avx2,     superhack_ar2_fill_segment_avx2 },
        { "AVX-512F",   superhack_ar2_check_avx512f,  superhack_ar2_fill_segment_avx512f },
    };
