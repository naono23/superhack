...
void superhack_ar2_blake2b_init(blake2b_state *S, size_t outlen)
{
...
void superhack_ar2_blake2b_update(blake2b_state *S, const void *in, size_t inlen)
{
...
void superhack_ar2_blake2b_final(blake2b_state *S, void *out, size_t outlen)
{
    ...
    superhack_ar2_clear_internal_memory(buffer, sizeof(buffer));
    superhack_ar2_clear_internal_memory(S->buf, sizeof(S->buf));
    superhack_ar2_clear_internal_memory(S->h, sizeof(S->h));
}

void superhack_ar2_blake2b_long(void *out, size_t outlen, const void *in, size_t inlen)
{
    ...
    if (outlen <= BLAKE2B_OUTBYTES) {
        superhack_ar2_blake2b_init(&blake_state, outlen);
        superhack_ar2_blake2b_update(&blake_state, outlen_bytes, sizeof(outlen_bytes));
        superhack_ar2_blake2b_update(&blake_state, in, inlen);
        superhack_ar2_blake2b_final(&blake_state, pout, outlen);
    } else {
        uint32_t toproduce;
        uint8_t out_buffer[BLAKE2B_OUTBYTES];

        superhack_ar2_blake2b_init(&blake_state, BLAKE2B_OUTBYTES);
        superhack_ar2_blake2b_update(&blake_state, outlen_bytes, sizeof(outlen_bytes));
        superhack_ar2_blake2b_update(&blake_state, in, inlen);
        superhack_ar2_blake2b_final(&blake_state, out_buffer, BLAKE2B_OUTBYTES);
        ...
        while (toproduce > BLAKE2B_OUTBYTES) {
            superhack_ar2_blake2b_init(&blake_state, BLAKE2B_OUTBYTES);
            superhack_ar2_blake2b_update(&blake_state, out_buffer, BLAKE2B_OUTBYTES);
            superhack_ar2_blake2b_final(&blake_state, out_buffer, BLAKE2B_OUTBYTES);
        ...
        superhack_ar2_blake2b_init(&blake_state, toproduce);
        superhack_ar2_blake2b_update(&blake_state, out_buffer, BLAKE2B_OUTBYTES);
        superhack_ar2_blake2b_final(&blake_state, out_buffer, toproduce);

        memcpy(pout, out_buffer, toproduce);

        superhack_ar2_clear_internal_memory(out_buffer, sizeof(out_buffer));
    }
}
