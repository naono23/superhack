...
#ifndef superhack_USAGE_H
#define superhack_USAGE_H
...
static inline const std::string &usage()
{
    ...
    u += "  -a, --algo=ALGO               mining algorithm https://superhack.com/docs/algorithms\n";
...
#   endif
    ...
    u += "      --donate-over-proxy=N     control donate over superhack-proxy feature\n";
...
#   ifdef superhack_FEATURE_CUDA
    ...
    u += "      --cuda-loader=PATH        path to CUDA plugin (superhack-cuda.dll or libsuperhack-cuda.so)\n";
