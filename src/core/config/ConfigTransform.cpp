...
void superhack::ConfigTransform::finalize(rapidjson::Document &doc)
{
...
void superhack::ConfigTransform::transform(rapidjson::Document &doc, int key, const char *arg)
{
...
void superhack::ConfigTransform::transformBoolean(rapidjson::Document &doc, int key, bool enable)
{
    switch (key) {
    case IConfig::HugePagesKey: /* --no-huge-pages */
...
void superhack::ConfigTransform::transformUint64(rapidjson::Document &doc, int key, uint64_t arg)
{
    using namespace rapidjson;
