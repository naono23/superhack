...
superhack::Hashrate::Hashrate(size_t threads) :
    m_threads(threads)
{
...
double superhack::Hashrate::calc(size_t ms) const
{
    double result = 0.0;
    double data;
...
double superhack::Hashrate::calc(size_t threadId, size_t ms) const
{
    ...
    const uint64_t timeStampLimit = superhack::Chrono::highResolutionMSecs() - ms;
...
void superhack::Hashrate::add(size_t threadId, uint64_t count, uint64_t timestamp)
{
...
const char *superhack::Hashrate::format(double h, char *buf, size_t size)
{
    return ::format(h, buf, size);
}


rapidjson::Value superhack::Hashrate::normalize(double d)
{
...
rapidjson::Value superhack::Hashrate::toJSON(rapidjson::Document &doc) const
{
...
rapidjson::Value superhack::Hashrate::toJSON(size_t threadId, rapidjson::Document &doc) const
{
    using namespace rapidjson;
    auto &allocator = doc.GetAllocator();
