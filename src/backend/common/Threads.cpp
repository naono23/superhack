...
template <class T>
const T &superhack::Threads<T>::get(const String &profileName) const
{
    static T empty;
...
template <class T>
size_t superhack::Threads<T>::read(const rapidjson::Value &value)
{
...
template <class T>
superhack::String superhack::Threads<T>::profileName(const Algorithm &algorithm, bool strict) const
{
...
template <class T>
void superhack::Threads<T>::toJSON(rapidjson::Value &out, rapidjson::Document &doc) const
{
    using namespace rapidjson;
