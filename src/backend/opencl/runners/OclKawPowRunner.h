...
#ifndef superhack_OCLKAWPOWRUNNER_H
#define superhack_OCLKAWPOWRUNNER_H
...
{
public:
    superhack_DISABLE_COPY_MOVE_DEFAULT(OclKawPowRunner)
...
#endif // superhack_OCLKAWPOWRUNNER_H
