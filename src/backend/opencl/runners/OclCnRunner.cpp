...
superhack::OclCnRunner::OclCnRunner(size_t index, const OclLaunchData &data) : OclBaseRunner(index, data)
{
...
superhack::OclCnRunner::~OclCnRunner()
{
    delete m_cn0;
    delete m_cn1;
    delete m_cn2;
...
size_t superhack::OclCnRunner::bufferSize() const
{
...
void superhack::OclCnRunner::run(uint32_t nonce, uint32_t *hashOutput)
{
...
void superhack::OclCnRunner::set(const Job &job, uint8_t *blob)
{
...
void superhack::OclCnRunner::build()
{
    OclBaseRunner::build();
...
void superhack::OclCnRunner::init()
{
    OclBaseRunner::init();
