...
superhack::OclRxJitRunner::OclRxJitRunner(size_t index, const OclLaunchData &data) : OclRxBaseRunner(index, data)
{
}


superhack::OclRxJitRunner::~OclRxJitRunner()
{
...
void superhack::OclRxJitRunner::execute(uint32_t iteration)
{
...
void superhack::OclRxJitRunner::init()
{
...
bool superhack::OclRxJitRunner::loadAsmProgram()
{
