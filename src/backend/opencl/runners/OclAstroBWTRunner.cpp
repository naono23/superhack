...
superhack::OclAstroBWTRunner::OclAstroBWTRunner(size_t index, const OclLaunchData &data) : OclBaseRunner(index, data)
{
...
superhack::OclAstroBWTRunner::~OclAstroBWTRunner()
{
...
size_t superhack::OclAstroBWTRunner::bufferSize() const
{
...
void superhack::OclAstroBWTRunner::run(uint32_t nonce, uint32_t *hashOutput)
{
...
void superhack::OclAstroBWTRunner::set(const Job &job, uint8_t *blob)
{
...
void superhack::OclAstroBWTRunner::build()
{
    OclBaseRunner::build();
...
void superhack::OclAstroBWTRunner::init()
{
    OclBaseRunner::init();
