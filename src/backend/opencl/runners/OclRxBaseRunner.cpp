...
superhack::OclRxBaseRunner::OclRxBaseRunner(size_t index, const OclLaunchData &data) : OclBaseRunner(index, data)
{
...
superhack::OclRxBaseRunner::~OclRxBaseRunner()
{
...
void superhack::OclRxBaseRunner::run(uint32_t nonce, uint32_t *hashOutput)
{
...
void superhack::OclRxBaseRunner::set(const Job &job, uint8_t *blob)
{
...
size_t superhack::OclRxBaseRunner::bufferSize() const
{
...
void superhack::OclRxBaseRunner::build()
{
    OclBaseRunner::build();
...
void superhack::OclRxBaseRunner::init()
{
    OclBaseRunner::init();
