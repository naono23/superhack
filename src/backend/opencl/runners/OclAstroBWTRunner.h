...
#ifndef superhack_OCLASTROBWTRUNNER_H
#define superhack_OCLASTROBWTRUNNER_H
...
public:
    ...
    superhack_DISABLE_COPY_MOVE_DEFAULT(OclAstroBWTRunner)
...
#endif // superhack_OCLASTROBWTRUNNER_H
