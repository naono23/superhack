...
superhack::OclRxVmRunner::OclRxVmRunner(size_t index, const OclLaunchData &data) : OclRxBaseRunner(index, data)
{
}


superhack::OclRxVmRunner::~OclRxVmRunner()
{
    delete m_init_vm;
    delete m_execute_vm;
...
size_t superhack::OclRxVmRunner::bufferSize() const
{
    return OclRxBaseRunner::bufferSize() + (align(2560 * m_intensity));
}


void superhack::OclRxVmRunner::build()
{
...
void superhack::OclRxVmRunner::execute(uint32_t iteration)
{
...
void superhack::OclRxVmRunner::init()
{
