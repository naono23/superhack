...
#ifndef superhack_OCLRXBASERUNNER_H
#define superhack_OCLRXBASERUNNER_H
...
{
public:
    superhack_DISABLE_COPY_MOVE_DEFAULT(OclRxBaseRunner)
...
#endif // superhack_OCLRXBASERUNNER_H
