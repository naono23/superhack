...
void superhack::Blake2bInitialHashKernel::enqueue(cl_command_queue queue, size_t threads)
{
...
void superhack::Blake2bInitialHashKernel::setArgs(cl_mem out, cl_mem blockTemplate)
{
...
void superhack::Blake2bInitialHashKernel::setBlobSize(size_t size)
{
...
void superhack::Blake2bInitialHashKernel::setNonce(uint32_t nonce)
{
