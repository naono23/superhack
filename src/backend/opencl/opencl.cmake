if (BUILD_STATIC AND superhack_OS_UNIX AND WITH_OPENCL)
...
if (WITH_OPENCL)
    ...
    add_definitions(/Dsuperhack_FEATURE_OPENCL)
    ...
    if (WITH_STRICT_CACHE)
        add_definitions(/Dsuperhack_STRICT_OPENCL_CACHE)
    else()
        remove_definitions(/Dsuperhack_STRICT_OPENCL_CACHE)
    endif()

    if (WITH_INTERLEAVE_DEBUG_LOG)
        add_definitions(/Dsuperhack_INTERLEAVE_DEBUG)
    endif()

    if (WITH_ADL AND (superhack_OS_WIN OR superhack_OS_LINUX))
        add_definitions(/Dsuperhack_FEATURE_ADL)
       ...
       remove_definitions(/Dsuperhack_FEATURE_ADL)
    endif()
else()
    remove_definitions(/Dsuperhack_FEATURE_OPENCL)
    remove_definitions(/Dsuperhack_FEATURE_ADL)
