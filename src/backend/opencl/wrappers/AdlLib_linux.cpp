...
const char *superhack::AdlLib::lastError() noexcept
{
    return nullptr;
}


void superhack::AdlLib::close()
{
}


// https://dri.freedesktop.org/docs/drm/gpu/amdgpu.html#gpu-power-thermal-controls-and-monitoring
AdlHealth superhack::AdlLib::health(const OclDevice &device)
{
