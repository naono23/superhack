...
std::vector<superhack::OclPlatform> superhack::OclPlatform::get()
{
...
void superhack::OclPlatform::print()
{
...
rapidjson::Value superhack::OclPlatform::toJSON(rapidjson::Document &doc) const
{
...
std::vector<superhack::OclDevice> superhack::OclPlatform::devices() const
{
...
superhack::String superhack::OclPlatform::extensions() const
{
    return OclLib::getString(id(), CL_PLATFORM_EXTENSIONS);
}


superhack::String superhack::OclPlatform::name() const
{
    return OclLib::getString(id(), CL_PLATFORM_NAME);
}


superhack::String superhack::OclPlatform::profile() const
{
    return OclLib::getString(id(), CL_PLATFORM_PROFILE);
}


superhack::String superhack::OclPlatform::vendor() const
{
    return OclLib::getString(id(), CL_PLATFORM_VENDOR);
}


superhack::String superhack::OclPlatform::version() const
{
