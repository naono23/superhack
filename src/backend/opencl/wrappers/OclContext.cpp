...
superhack::OclContext::OclContext(const OclDevice &device)
{
...
superhack::OclContext::~OclContext()
{
    if (m_ctx) {
...
bool superhack::OclContext::init(const std::vector<OclDevice> &devices, std::vector<OclLaunchData> &threads)
{
    if (!m_ctx) {
