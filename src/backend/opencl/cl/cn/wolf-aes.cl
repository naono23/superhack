...
#   define superhack_amd_bfe(src0, src1, src2) amd_bfe(src0, src1, src2)
#else
 ...
 */
inline int superhack_amd_bfe(const uint src0, const uint offset, const uint width)
{
...
#define BYTE(x, y) (superhack_amd_bfe((x), (y) << 3U, 8U))
