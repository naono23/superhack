...
superhack::CpuThreads::CpuThreads(const rapidjson::Value &value)
{
    if (value.IsArray()) {
...
superhack::CpuThreads::CpuThreads(size_t count, uint32_t intensity)
{
...
bool superhack::CpuThreads::isEqual(const CpuThreads &other) const
{
...
rapidjson::Value superhack::CpuThreads::toJSON(rapidjson::Document &doc) const
{
