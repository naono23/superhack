...
if (WITH_HWLOC)
    ...
    remove_definitions(/Dsuperhack_FEATURE_LIBCPUID)
    add_definitions(/Dsuperhack_FEATURE_HWLOC)

    if (HWLOC_DEBUG)
        add_definitions(/Dsuperhack_HWLOC_DEBUG)
    endif()
...
elseif (WITH_LIBCPUID)
    ...
    add_definitions(/Dsuperhack_FEATURE_LIBCPUID)
    remove_definitions(/Dsuperhack_FEATURE_HWLOC)
