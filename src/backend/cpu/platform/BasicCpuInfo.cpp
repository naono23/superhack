 ...
 * Copyright 2016-2020 superhack       <support@superhack.com>
 *
...
int cpu_flags_has_avx2()    { return superhack::has_avx2(); }
int cpu_flags_has_avx512f() { return superhack::has_avx512f(); }
int cpu_flags_has_sse2()    { return superhack::has_sse2(); }
int cpu_flags_has_ssse3()   { return superhack::has_ssse3(); }
int cpu_flags_has_xop()     { return superhack::has_xop(); }
...
superhack::BasicCpuInfo::BasicCpuInfo() :
...
const char *superhack::BasicCpuInfo::backend() const
{
    return "basic/1";
}


superhack::CpuThreads superhack::BasicCpuInfo::threads(const Algorithm &algorithm, uint32_t) const
{
...
rapidjson::Value superhack::BasicCpuInfo::toJSON(rapidjson::Document &doc) const
{
