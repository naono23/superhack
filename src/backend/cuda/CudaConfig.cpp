...
rapidjson::Value superhack::CudaConfig::toJSON(rapidjson::Document &doc) const
{
...
std::vector<superhack::CudaLaunchData> superhack::CudaConfig::get(const Miner *miner, const Algorithm &algorithm, const std::vector<CudaDevice> &devices) const
{
...
void superhack::CudaConfig::read(const rapidjson::Value &value)
{
    if (value.IsObject()) {
...
void superhack::CudaConfig::generate()
{
    if (generated) {
        return;
    }
...
void superhack::CudaConfig::setDevicesHint(const char *devicesHint)
{
