if (BUILD_STATIC AND superhack_OS_UNIX AND WITH_CUDA)
...
if (WITH_CUDA)
    add_definitions(/Dsuperhack_FEATURE_CUDA)
   ...
   if (WITH_NVML AND NOT APPLE)
       add_definitions(/Dsuperhack_FEATURE_NVML)
       ...
       remove_definitions(/Dsuperhack_FEATURE_NVML)
   endif()
   ...
   if (WITH_KAWPOW)
    ...
    remove_definitions(/Dsuperhack_FEATURE_CUDA)
    remove_definitions(/Dsuperhack_FEATURE_NVML)
