 ...
 * Copyright 2016-2019 superhack       <support@superhack.com>
 *
...
#   if defined(superhack_FEATURE_LIBCPUID) || defined (superhack_FEATURE_HWLOC)
...
void superhack::Summary::print(Controller *controller)
{
