...
#ifndef superhack_CRYPTONIGHT_X86_H
#define superhack_CRYPTONIGHT_X86_H
...
void v4_soft_aes_compile_code(const V4_Instruction *code, int code_size, void *machine_code, superhack::Assembly ASM);
...
void v4_compile_code(const V4_Instruction* code, int code_size, void* machine_code, superhack::Assembly ASM);
void v4_compile_code_double(const V4_Instruction* code, int code_size, void* machine_code, superhack::Assembly ASM);


template<superhack::Algorithm::Id ALGO>
void cn_r_compile_code(const V4_Instruction* code, int code_size, void* machine_code, superhack::Assembly ASM)
{
...
template<superhack::Algorithm::Id ALGO>
void cn_r_compile_code_double(const V4_Instruction* code, int code_size, void* machine_code, superhack::Assembly ASM)
{
...
#endif /* superhack_CRYPTONIGHT_X86_H */
