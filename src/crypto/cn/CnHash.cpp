...
static const superhack::CnHash cnHash;


superhack::CnHash::CnHash()
{
...
superhack::cn_hash_fun superhack::CnHash::fn(const Algorithm &algorithm, AlgoVariant av, Assembly::Id assembly)
{
