...
superhack::MsrItem::MsrItem(const rapidjson::Value &value)
{
    if (!value.IsString()) {
        return;
    }
...
rapidjson::Value superhack::MsrItem::toJSON(rapidjson::Document &doc) const
{
    return toString().toJSON(doc);
}


superhack::String superhack::MsrItem::toString() const
{
