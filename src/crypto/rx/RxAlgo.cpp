...
superhack::Algorithm::Id superhack::RxAlgo::apply(Algorithm::Id algorithm)
{
...
const RandomX_ConfigurationBase *superhack::RxAlgo::base(Algorithm::Id algorithm)
{
    switch (algorithm) {
...
uint32_t superhack::RxAlgo::version(Algorithm::Id algorithm)
{
    return algorithm == Algorithm::RX_WOW ? 103 : 104;
}


uint32_t superhack::RxAlgo::programCount(Algorithm::Id algorithm)
{
    return base(algorithm)->ProgramCount;
}


uint32_t superhack::RxAlgo::programIterations(Algorithm::Id algorithm)
{
    return base(algorithm)->ProgramIterations;
}


uint32_t superhack::RxAlgo::programSize(Algorithm::Id algorithm)
{
