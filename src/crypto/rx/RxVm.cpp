...
randomx_vm* superhack::RxVm::create(RxDataset *dataset, uint8_t *scratchpad, bool softAes, superhack::Assembly assembly, uint32_t node)
{
    int flags = 0;
...
void superhack::RxVm::destroy(randomx_vm* vm)
{
    if (vm) {
