...
superhack::Assembly::Id superhack::Assembly::parse(const char *assembly, Id defaultValue)
{
...
superhack::Assembly::Id superhack::Assembly::parse(const rapidjson::Value &value, Id defaultValue)
{
    if (value.IsBool()) {
...
const char *superhack::Assembly::toString() const
{
    return asmNames[m_id];
}


rapidjson::Value superhack::Assembly::toJSON() const
{
