...
void *superhack::VirtualMemory::allocateOneGbPagesMemory(size_t)
{
    return nullptr;
}
...
void superhack::VirtualMemory::freeLargePagesMemory(void *p, size_t)
{
...
void superhack::VirtualMemory::osInit(bool hugePages)
{
    if (hugePages) {
