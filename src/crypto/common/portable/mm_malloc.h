...
#ifndef superhack_MM_MALLOC_PORTABLE_H
#define superhack_MM_MALLOC_PORTABLE_H


#if defined(superhack_ARM) && !defined(__clang__)
#include <stdlib.h>
...
#endif /* superhack_MM_MALLOC_PORTABLE_H */
