...
bool superhack::LinuxMemory::reserve(size_t size, uint32_t node, bool oneGbPages)
{
...
bool superhack::LinuxMemory::write(const char *path, uint64_t value)
{
...
int64_t superhack::LinuxMemory::read(const char *path)
{
