...
#ifndef superhack_ARGON2_HASH_H
#define superhack_ARGON2_HASH_H
...
namespace superhack { namespace argon2 {
...
}} // namespace superhack::argon2


#endif /* superhack_ARGON2_HASH_H */
