...
superhack::Network::Network(Controller *controller) :
...
void superhack::Network::connect()
{
    m_strategy->connect();
}


void superhack::Network::execCommand(char command)
{
    switch (command) {
    case 's':
    case 'S':
...
void superhack::Network::onActive(IStrategy *strategy, IClient *client)
{
...
void superhack::Network::onConfigChanged(Config *config, Config *previousConfig)
{
...
void superhack::Network::onJob(IStrategy *strategy, IClient *client, const Job &job, const rapidjson::Value &)
{
...
void superhack::Network::onJobResult(const JobResult &result)
{
...
void superhack::Network::onLogin(IStrategy *, IClient *client, rapidjson::Document &doc, rapidjson::Value &params)
{
...
void superhack::Network::onPause(IStrategy *strategy)
{
    if (m_donate && m_donate == strategy) {
...
void superhack::Network::onResultAccepted(IStrategy *, IClient *, const SubmitResult &result, const char *error)
{
...
void superhack::Network::onVerifyAlgorithm(IStrategy *, const IClient *, const Algorithm &algorithm, bool *ok)
{
...
#ifdef superhack_FEATURE_API
void superhack::Network::onRequest(IApiRequest &request)
{
...
void superhack::Network::setJob(IClient *client, const Job &job, bool donate)
{
...
#ifdef superhack_FEATURE_API
void superhack::Network::getConnection(rapidjson::Value &reply, rapidjson::Document &doc, int version) const
{
    using namespace rapidjson;
    auto &allocator = doc.GetAllocator();
...
void superhack::Network::getResults(rapidjson::Value &reply, rapidjson::Document &doc, int version) const
{
    using namespace rapidjson;
    auto &allocator = doc.GetAllocator();
