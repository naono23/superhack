...
superhack::HttpsServer::HttpsServer(const std::shared_ptr<IHttpListener> &listener) :
    m_listener(listener)
{
}


superhack::HttpsServer::~HttpsServer()
{
...
bool superhack::HttpsServer::setTls(const TlsConfig &config)
{
...
void superhack::HttpsServer::onConnection(uv_stream_t *stream, uint16_t)
{
...
void superhack::HttpsServer::onRead(uv_stream_t *stream, ssize_t nread, const uv_buf_t *buf)
{
