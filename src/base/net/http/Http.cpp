...
bool superhack::Http::isEqual(const Http &other) const
{
...
rapidjson::Value superhack::Http::toJSON(rapidjson::Document &doc) const
{
...
void superhack::Http::load(const rapidjson::Value &http)
{
    if (!http.IsObject()) {
        return;
    }
...
void superhack::Http::setPort(int port)
{
