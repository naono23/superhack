...
superhack::HttpApiResponse::HttpApiResponse(uint64_t id) :
    HttpResponse(id),
...
superhack::HttpApiResponse::HttpApiResponse(uint64_t id, int status) :
    HttpResponse(id),
    m_doc(rapidjson::kObjectType)
{
    setStatus(status);
...
void superhack::HttpApiResponse::end()
{
