...
superhack::HttpResponse::HttpResponse(uint64_t id, int statusCode) :
    m_id(id),
...
bool superhack::HttpResponse::isAlive() const
{
...
void superhack::HttpResponse::end(const char *data, size_t size)
{
    if (!isAlive()) {
        return;
    }
