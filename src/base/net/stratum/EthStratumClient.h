...
#ifndef superhack_ETHSTRATUMCLIENT_H
#define superhack_ETHSTRATUMCLIENT_H
...
{
public:
    superhack_DISABLE_COPY_MOVE_DEFAULT(EthStratumClient)
...
#endif /* superhack_ETHSTRATUMCLIENT_H */
