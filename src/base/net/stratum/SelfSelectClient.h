...
#ifndef superhack_SELFSELECTCLIENT_H
#define superhack_SELFSELECTCLIENT_H
...
{
public:
    superhack_DISABLE_COPY_MOVE_DEFAULT(SelfSelectClient)
...
#endif /* superhack_SELFSELECTCLIENT_H */
