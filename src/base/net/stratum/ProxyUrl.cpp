...
superhack::ProxyUrl::ProxyUrl(const rapidjson::Value &value)
{
    m_port = 0;
...
const superhack::String &superhack::ProxyUrl::host() const
{
    return m_host.isNull() && isValid() ? kLocalhost : m_host;
}


rapidjson::Value superhack::ProxyUrl::toJSON(rapidjson::Document &doc) const
{
