...
#ifndef superhack_FAILOVERSTRATEGY_H
#define superhack_FAILOVERSTRATEGY_H
...
{
public:
    superhack_DISABLE_COPY_MOVE_DEFAULT(FailoverStrategy)
...
#endif /* superhack_FAILOVERSTRATEGY_H */
