...
#ifndef superhack_SINGLEPOOLSTRATEGY_H
#define superhack_SINGLEPOOLSTRATEGY_H
...
{
public:
    superhack_DISABLE_COPY_MOVE_DEFAULT(SinglePoolStrategy)
...
#endif /* superhack_SINGLEPOOLSTRATEGY_H */
