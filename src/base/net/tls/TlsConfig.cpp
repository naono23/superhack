 ...
 */
superhack::TlsConfig::TlsConfig(const rapidjson::Value &value)
{
    if (value.IsObject()) {
...
bool superhack::TlsConfig::generate(const char *commonName)
{
    TlsGen gen;
...
rapidjson::Value superhack::TlsConfig::toJSON(rapidjson::Document &doc) const
{
...
void superhack::TlsConfig::setProtocols(const char *protocols)
{
...
void superhack::TlsConfig::setProtocols(const rapidjson::Value &protocols)
{
    m_protocols = 0;
