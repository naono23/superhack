...
void superhack::TlsGen::generate(const char *commonName)
{
...
bool superhack::TlsGen::generate_x509(const char *commonName)
{
    m_x509 = X509_new();
    if (!m_x509) {
        return false;
