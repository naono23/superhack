...
superhack::LineReader::~LineReader()
{
    NetBuffer::release(m_buf);
}


void superhack::LineReader::parse(char *data, size_t size)
{
...
void superhack::LineReader::reset()
{
    if (m_buf) {
        NetBuffer::release(m_buf);
        m_buf = nullptr;
...
void superhack::LineReader::add(const char *data, size_t size)
{
...
void superhack::LineReader::getline(char *data, size_t size)
{
    char *end        = nullptr;
    char *start      = data;
