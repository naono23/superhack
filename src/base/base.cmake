...
if (WITH_HTTP)
    ...
    add_definitions(/Dsuperhack_FEATURE_HTTP)
    add_definitions(/Dsuperhack_FEATURE_API)
else()
    set(HEADERS_BASE_HTTP "")
    set(SOURCES_BASE_HTTP "")
    remove_definitions(/Dsuperhack_FEATURE_HTTP)
    remove_definitions(/Dsuperhack_FEATURE_API)
endif()
...
if (WITH_ENV_VARS)
    add_definitions(/Dsuperhack_FEATURE_ENV)
else()
    remove_definitions(/Dsuperhack_FEATURE_ENV)
endif()
