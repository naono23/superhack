...
superhack::Algorithm::Id superhack::Coin::algorithm(uint8_t blobVersion) const
{
    switch (id()) {
    case MONERO:
...
const char *superhack::Coin::name() const
{
...
rapidjson::Value superhack::Coin::toJSON() const
{
...
superhack::Coin::Id superhack::Coin::parse(const char *name)
{
