...
#ifndef superhack_LOG_H
#define superhack_LOG_H
...
#define LOG_EMERG(x, ...)   superhack::Log::print(superhack::Log::EMERG,   x, ##__VA_ARGS__)
#define LOG_ALERT(x, ...)   superhack::Log::print(superhack::Log::ALERT,   x, ##__VA_ARGS__)
#define LOG_CRIT(x, ...)    superhack::Log::print(superhack::Log::CRIT,    x, ##__VA_ARGS__)
#define LOG_ERR(x, ...)     superhack::Log::print(superhack::Log::ERR,     x, ##__VA_ARGS__)
#define LOG_WARN(x, ...)    superhack::Log::print(superhack::Log::WARNING, x, ##__VA_ARGS__)
#define LOG_NOTICE(x, ...)  superhack::Log::print(superhack::Log::NOTICE,  x, ##__VA_ARGS__)
#define LOG_INFO(x, ...)    superhack::Log::print(superhack::Log::INFO,    x, ##__VA_ARGS__)
#define LOG_VERBOSE(x, ...) if (superhack::Log::verbose() > 0) { superhack::Log::print(superhack::Log::INFO, x, ##__VA_ARGS__); }
#define LOG_V1(x, ...)      if (superhack::Log::verbose() > 0) { superhack::Log::print(superhack::Log::INFO, x, ##__VA_ARGS__); }
#define LOG_V2(x, ...)      if (superhack::Log::verbose() > 1) { superhack::Log::print(superhack::Log::INFO, x, ##__VA_ARGS__); }
#define LOG_V3(x, ...)      if (superhack::Log::verbose() > 2) { superhack::Log::print(superhack::Log::INFO, x, ##__VA_ARGS__); }
#define LOG_V4(x, ...)      if (superhack::Log::verbose() > 3) { superhack::Log::print(superhack::Log::INFO, x, ##__VA_ARGS__); }
#define LOG_V5(x, ...)      if (superhack::Log::verbose() > 4) { superhack::Log::print(superhack::Log::INFO, x, ##__VA_ARGS__); }

#ifdef APP_DEBUG
#   define LOG_DEBUG(x, ...) superhack::Log::print(superhack::Log::DEBUG, x, ##__VA_ARGS__)
#else
#   define LOG_DEBUG(x, ...)
#endif

#if defined(APP_DEBUG) || defined(APP_DEVEL)
#   define LOG_DEBUG_ERR(x, ...)  superhack::Log::print(superhack::Log::ERR,     x, ##__VA_ARGS__)
#   define LOG_DEBUG_WARN(x, ...) superhack::Log::print(superhack::Log::WARNING, x, ##__VA_ARGS__)
#else
