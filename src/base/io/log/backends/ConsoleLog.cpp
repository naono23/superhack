...
superhack::ConsoleLog::ConsoleLog(const Title &title)
{
    if (!isSupported()) {
        Log::setColors(false);
        return;
...
superhack::ConsoleLog::~ConsoleLog()
{
    Handle::close(m_tty);
}


void superhack::ConsoleLog::print(int, const char *line, size_t, size_t size, bool colors)
{
...
bool superhack::ConsoleLog::isSupported() const
{
...
#ifdef superhack_OS_WIN
bool superhack::ConsoleLog::isWritable() const
{
