...
void superhack::Api::request(const HttpData &req)
{
...
void superhack::Api::onConfigChanged(Config *config, Config *previousConfig)
{
...
void superhack::Api::exec(IApiRequest &request)
{
    using namespace rapidjson;
...
#       endif
#       ifdef superhack_FEATURE_LIBCPUID
...
void superhack::Api::genId(const String &id)
{
...
void superhack::Api::genWorkerId(const String &id)
{
