...
superhack::HttpApiRequest::HttpApiRequest(const HttpData &req, bool restricted) :
...
bool superhack::HttpApiRequest::accept()
{
...
const rapidjson::Value &superhack::HttpApiRequest::json() const
{
    if (type() == REQ_JSON_RPC) {
...
superhack::IApiRequest::Method superhack::HttpApiRequest::method() const
{
    return static_cast<IApiRequest::Method>(m_req.method);
}


void superhack::HttpApiRequest::done(int status)
{
...
void superhack::HttpApiRequest::setRpcError(int code, const char *message)
{
    using namespace rapidjson;
    auto &allocator = doc().GetAllocator();
...
void superhack::HttpApiRequest::setRpcResult(rapidjson::Value &result)
{
    rpcDone(kResult, result);
}


void superhack::HttpApiRequest::rpcDone(const char *key, rapidjson::Value &value)
{
    ApiRequest::done(0);
