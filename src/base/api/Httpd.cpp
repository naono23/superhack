...
superhack::Httpd::Httpd(Base *base) :
    m_base(base)
{
...
superhack::Httpd::~Httpd() = default;


bool superhack::Httpd::start()
{
...
void superhack::Httpd::onConfigChanged(Config *config, Config *previousConfig)
{
...
void superhack::Httpd::onHttpData(const HttpData &data)
{
...
int superhack::Httpd::auth(const HttpData &req) const
{
