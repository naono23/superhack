...
char *superhack::Platform::createUserAgent()
{
...
bool superhack::Platform::setThreadAffinity(uint64_t cpu_id)
{
...
void superhack::Platform::setProcessPriority(int priority)
{
    if (priority == -1) {
        return;
    }
...
void superhack::Platform::setThreadPriority(int priority)
{
    if (priority == -1) {
        return;
    }
...
bool superhack::Platform::isOnBatteryPower()
{
