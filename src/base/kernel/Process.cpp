...
superhack::Process::Process(int argc, char **argv) :
...
superhack::String superhack::Process::exepath()
{
    size_t size = sizeof(pathBuf);
...
superhack::String superhack::Process::location(Location location, const char *fileName)
{
