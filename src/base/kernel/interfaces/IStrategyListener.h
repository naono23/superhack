...
#ifndef superhack_ISTRATEGYLISTENER_H
#define superhack_ISTRATEGYLISTENER_H
...
{
public:
    superhack_DISABLE_COPY_MOVE(IStrategyListener);
...
#endif // superhack_ISTRATEGYLISTENER_H
