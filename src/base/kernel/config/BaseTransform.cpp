...
void superhack::BaseTransform::load(JsonChain &chain, Process *process, IConfigTransform &transform)
{
...
void superhack::BaseTransform::finalize(rapidjson::Document &doc)
{
    using namespace rapidjson;
...
void superhack::BaseTransform::transform(rapidjson::Document &doc, int key, const char *arg)
{
    switch (key) {
...
void superhack::BaseTransform::transformBoolean(rapidjson::Document &doc, int key, bool enable)
{
    switch (key) {
    case IConfig::BackgroundKey: /* --background */
...
void superhack::BaseTransform::transformUint64(rapidjson::Document &doc, int key, uint64_t arg)
{
    switch (key) {
    case IConfig::RetriesKey: /* --retries */
