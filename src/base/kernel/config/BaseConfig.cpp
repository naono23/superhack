...
bool superhack::BaseConfig::read(const IJsonReader &reader, const char *fileName)
{
    m_fileName = fileName;
...
bool superhack::BaseConfig::save()
{
...
void superhack::BaseConfig::printVersions()
{
    char buf[256] = { 0 };
...
#   if defined(superhack_FEATURE_TLS)
    {
...
void superhack::BaseConfig::setVerbose(const rapidjson::Value &value)
{
    if (value.IsBool()) {
