...
function cn()
{
    ...
    fs.writeFileSync('cryptonight_cl.h', text2h(cn, 'superhack', 'cryptonight_cl'));
}
...
function cn_r()
{
    ...
    fs.writeFileSync('cryptonight_r_cl.h', text2h_bundle('superhack', items));
}
...
function rx()
{
    ...
    fs.writeFileSync('randomx_cl.h', text2h(rx, 'superhack', 'randomx_cl'));
}
...
function astrobwt()
{
    ...
    fs.writeFileSync('astrobwt_cl.h', text2h(astrobwt, 'superhack', 'astrobwt_cl'));
}
...
function kawpow()
{
    ...
    fs.writeFileSync('kawpow_cl.h', text2h(kawpow, 'superhack', 'kawpow_cl'));
    fs.writeFileSync('kawpow_dag_cl.h', text2h(kawpow_dag, 'superhack', 'kawpow_dag_cl'));
}
